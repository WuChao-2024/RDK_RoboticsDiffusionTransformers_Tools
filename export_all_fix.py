...
def main():
    ...
    parser.add_argument('--pretrained_model', type=str, default="policy/BPU_RDT/checkpoints/RDT170M_task3_S100_Clean/checkpoint-22500/pytorch_model/mp_rank_00_model_states.pt", help="")
